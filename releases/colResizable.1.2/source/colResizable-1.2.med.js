...
(function($){ 	
	...
	h = $("head")[ap](st+".CRZ{table-layout:fixed}.CRZ td,.CRZ th{"+pa+le+zi+pa+"right"+zi+"overflow:hidden}.CRC{height:0px;"+U+":relative}.CRG{margin-left:-5px;"+U+A+" z-index:5}.CRG .CRZ{"+U+A+"background-color:red;filter:alpha(opacity=1);opacity:0;width:10px;"+cres+";height:100%;top:0px}.CRL{"+U+A+"width:1px}.CRD{border-left:1px dotted black"+se),			
	N = null,	
	D = N,			
	T = [],
	c = 0,	
	...
	function g(t){	
		t.d[wi](t.w);					
		for(var c,o='outerHeight',i=0; i<t.l; i++){	
			c = t.c[i]; 			
			t.g[i].css({			
				left: c.offset()[le] - t.offset()[le] + c.outerWidth() + t.s / 2 + p,
				height: t.o.headerOnly? t.c[0][o]() :t[o]()
			});												
		} 	
	}
